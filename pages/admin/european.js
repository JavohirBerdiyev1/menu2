...
export default function AdminEuropean() {
  ...
  useEffect(() => {
    ...
    setToken(t);
    fetch('/api/menu?menuType=european', { headers: { Authorization: `Bearer ${t}` } })
      .then((r) => r.json())
    ...
    <div className="min-h-screen w-full bg-base text-white">
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl md:text-3xl font-semibold text-white">European Menu</h1>
                              ...
                              <button
                                ...
                                onClick={async () => {
                                  ...
                                  try {
                                    ...
                                    // Revert on failure
                                    const reverted = { ...europeanData };
                                    setEuropeanData(reverted);
                                  }
                                }}
                                className={`w-8 h-4 rounded-full transition-colors ${
